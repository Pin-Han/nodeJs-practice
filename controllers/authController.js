...
exports.isLoggedIn = async (req, res, next) => {
  if (req.cookies.jwt) {
    try {
      ...
      // THERE IS A LOGGED IN USER （Pug automatically gets the Locals value in the current response)
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  // validateBeforeSave -> will deactivate all the validaters that we specificed in our schema.
